...
export KL_ANNEAL_START="0"
export KL_ANNEAL_STEPS="20000"
export DISC_START="10000"
export DISC_WARMUP_STEPS="10000"
export DISC_WEIGHT="0.05"
export DECODER_OUTPUT="tanh"
export INPUT_RANGE="neg_one_one"
export RECON_LOSS="l1"
export EPOCHS="100"
...
export SLURM_JOB_NAME="pneumonia-ae-proto"
...
export WANDB_TAGS="${WANDB_TAGS:-vae,pneumonia,z${Z_CHANNELS},${GIT_BRANCH},${GIT_HASH}}"
...
echo "Submitting VAE Training for Pneumonia with Z_CHANNELS=${Z_CHANNELS}"
